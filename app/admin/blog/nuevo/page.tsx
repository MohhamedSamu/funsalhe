        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-8 space-y-6">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-500">
              Sube la imagen a un servicio de almacenamiento (Supabase Storage, Cloudinary, etc.) y pega la URL aquí
            </p>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Escribe el contenido aquí. Puedes usar HTML básico: &lt;p&gt;, &lt;strong&gt;, &lt;em&gt;, &lt;ul&gt;, &lt;li&gt;, etc."
            />
            <p className="mt-2 text-sm text-gray-500">
